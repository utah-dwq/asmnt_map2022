...
####################################################
# To deploy:
# rmarkdown::render_site("working/directory/index.Rmd")
# this generates a webpage in the WD
# note you will get a warning about an empty title element, but this can be ignored.
